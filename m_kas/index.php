            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php
                   ...
                   $sql = $conn->prepare("SELECT * FROM `m_kas` WHERE shipper_id = 0 AND stat = 1 AND `created_at` BETWEEN '".date("Y-m-01 00:00:01")."' AND '".date("Y-m-t 23:59:59")."' ORDER BY id DESC");
                   $sql->execute();
                ...
                <b>Masuk Bulanan = <?= "Rp. ".number_format($totals,0).",-" ?></b> <br>
